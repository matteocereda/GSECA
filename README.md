...
-  **2. Data Discretization (DD)**: once the sample-specific parameters of the FMM are estimated, GSECA implements a supervised data discretization approach, identifying 7 (default) Expression Classes (EC). Each gene is assigned to one of these EC, accordingly to its expression level.
